...
from settings import valid_email, valid_password, images
import os
...
def test_successful_add_self_pet_without_photo_1(name='Буян - без фото', animal_type='Собака', age=3):
...
def test_add_new_pet_with_valid_data_1(name='Буян', animal_type='Собака', age='0',
...
def test_get_my_pets_with_valid_key_1(filter='my_pets'):  # - тест падает если список пустой
    ...
    if len(result['pets']) > 0:
        ...
        # если список питомцев пустой, то выкидываем исключение с текстом об отсутствии своих питомцев
        raise Exception("There is no my pets")
    """Нужно довести до ума работу исключения, чтобы тест проходил успешно"""
...
def test_successful_delete_self_pet_1():
    ...
    # pet_id = '3b10419f-23b0-43a3-8845-3e588c3e0638'
